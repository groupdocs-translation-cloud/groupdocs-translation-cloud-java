...
public class PresentationFileRequest {
  ...
  public PresentationFileRequest sourceLanguage(@javax.annotation.Nullable String sourceLanguage) {
  ...
  public PresentationFileRequest targetLanguages(@javax.annotation.Nullable List<String> targetLanguages) {
  ...
  public PresentationFileRequest _file(@javax.annotation.Nullable byte[] _file) {
    this._file = _file;
    return this;
  }
  ...
  public PresentationFileRequest originalFileName(@javax.annotation.Nullable String originalFileName) {
  ...
  public PresentationFileRequest url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public PresentationFileRequest origin(@javax.annotation.Nullable String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public PresentationFileRequest savingMode(@javax.annotation.Nullable SavingModeEnum savingMode) {
  ...
  public PresentationFileRequest format(@javax.annotation.Nullable FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  public PresentationFileRequest outputFormat(@javax.annotation.Nullable String outputFormat) {
  ...
  public PresentationFileRequest masters(@javax.annotation.Nullable Boolean masters) {
  ...
  public PresentationFileRequest slides(@javax.annotation.Nullable List<Integer> slides) {
    this.slides = slides;
    return this;
  }
  ...
  public void setSlides(@javax.annotation.Nullable List<Integer> slides) {
    this.slides = slides;
  }
