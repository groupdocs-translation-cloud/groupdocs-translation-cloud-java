...
public class HtmlFileRequest {
  ...
  public HtmlFileRequest sourceLanguage(@javax.annotation.Nullable String sourceLanguage) {
  ...
  public HtmlFileRequest targetLanguages(@javax.annotation.Nullable List<String> targetLanguages) {
  ...
  public HtmlFileRequest _file(@javax.annotation.Nullable byte[] _file) {
    this._file = _file;
    return this;
  }
  ...
  public HtmlFileRequest originalFileName(@javax.annotation.Nullable String originalFileName) {
  ...
  public HtmlFileRequest url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public HtmlFileRequest origin(@javax.annotation.Nullable String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public HtmlFileRequest savingMode(@javax.annotation.Nullable SavingModeEnum savingMode) {
  ...
  public HtmlFileRequest outputFormat(@javax.annotation.Nullable String outputFormat) {
