...
public class CsvFileRequest {
  ...
  public CsvFileRequest sourceLanguage(@javax.annotation.Nonnull String sourceLanguage) {
  ...
  public CsvFileRequest targetLanguages(@javax.annotation.Nonnull List<String> targetLanguages) {
  ...
  public CsvFileRequest _file(@javax.annotation.Nullable byte[] _file) {
    this._file = _file;
    return this;
  }
  ...
  public CsvFileRequest originalFileName(@javax.annotation.Nullable String originalFileName) {
  ...
  public CsvFileRequest url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public CsvFileRequest origin(@javax.annotation.Nullable String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public CsvFileRequest savingMode(@javax.annotation.Nullable SavingModeEnum savingMode) {
  ...
  public CsvFileRequest format(@javax.annotation.Nullable FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  public CsvFileRequest outputFormat(@javax.annotation.Nonnull String outputFormat) {
  ...
  public CsvFileRequest separator(@javax.annotation.Nullable String separator) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceLanguage, csvFileRequest.sourceLanguage) &&
        ...
        Objects.equals(this.outputFormat, csvFileRequest.outputFormat) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, Arrays.hashCode(_file), originalFileName, url, origin, savingMode, format, outputFormat, separator);
  }
