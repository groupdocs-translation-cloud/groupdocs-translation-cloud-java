...
public class CloudTextResponse {
  ...
  public CloudTextResponse status(HttpStatusCode status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public CloudTextResponse message(String message) {
  ...
  **/
  ...
  public CloudTextResponse translations(Map<String, List<String>> translations) {
