...
public class FileRequest {
  ...
  **/
  ...
  public FileRequest shortcodedict(Map<String, List<String>> shortcodedict) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sourceLanguage, targetLanguages, Arrays.hashCode(_file), originalFileName, url, origin, savingMode, format, outputFormat, masters, formatting, route, separator, elements, ranges, shortcodedict, frontMatterList);
  }
