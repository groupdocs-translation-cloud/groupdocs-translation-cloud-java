...
public class TextRequest {
  ...
  public TextRequest sourceLanguage(@javax.annotation.Nullable String sourceLanguage) {
  ...
  public TextRequest targetLanguages(@javax.annotation.Nullable List<String> targetLanguages) {
  ...
  public TextRequest texts(@javax.annotation.Nullable List<String> texts) {
    this.texts = texts;
    return this;
  }
  ...
  public TextRequest origin(@javax.annotation.Nullable String origin) {
    this.origin = origin;
    return this;
  }
  ...
  public TextRequest containsMarkdown(@javax.annotation.Nullable Boolean containsMarkdown) {
  ...
  public void setContainsMarkdown(@javax.annotation.Nullable Boolean containsMarkdown) {
    this.containsMarkdown = containsMarkdown;
  }
