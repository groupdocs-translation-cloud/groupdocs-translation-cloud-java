...
public class CloudFileRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(format, outFormat, requestId, ids, summarized, url, size, masters, formatting, origin, elements, ranges, shortCodeDict, frontMatterList, originalFileName, separator, isPaid, savingMode, details);
  }
