...
public class PdfFileRequest {
  ...
  public PdfFileRequest sourceLanguage(String sourceLanguage) {
  ...
  **/
  ...
  public PdfFileRequest targetLanguages(List<String> targetLanguages) {
  ...
  **/
  ...
  public PdfFileRequest _file(byte[] _file) {
    this._file = _file;
    return this;
  }
  ...
  **/
  ...
  public PdfFileRequest originalFileName(String originalFileName) {
  ...
  **/
  ...
  public PdfFileRequest url(String url) {
    this.url = url;
    return this;
  }
  ...
  **/
  ...
  public PdfFileRequest origin(String origin) {
    this.origin = origin;
    return this;
  }
  ...
  **/
  ...
  public PdfFileRequest savingMode(SavingModeEnum savingMode) {
  ...
  **/
  ...
  public PdfFileRequest outputFormat(String outputFormat) {
  ...
  **/
  ...
  public PdfFileRequest preserveFormatting(Boolean preserveFormatting) {
  ...
  **/
  ...
  public PdfFileRequest pages(List<Integer> pages) {
    this.pages = pages;
    return this;
  }
