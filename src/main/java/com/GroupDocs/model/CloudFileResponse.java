...
public class CloudFileResponse {
  ...
  public CloudFileResponse status(@javax.annotation.Nullable HttpStatusCode status) {
    this.status = status;
    return this;
  }
  ...
  public CloudFileResponse message(@javax.annotation.Nullable String message) {
  ...
  public CloudFileResponse urls(@javax.annotation.Nullable Map<String, UrlFileInfo> urls) {
    this.urls = urls;
    return this;
  }
  ...
  public CloudFileResponse scores(@javax.annotation.Nullable Map<String, Float> scores) {
    this.scores = scores;
    return this;
  }
